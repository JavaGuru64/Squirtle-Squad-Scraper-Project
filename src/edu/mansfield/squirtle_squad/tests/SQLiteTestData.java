...
public class SQLiteTestData {
	// DO NOT RUN THIS IF YOU ALREADY HAVE REAL DATA IN THE DATABASE, YOU WILL
	// DO SERIOUS HARAM.
	public static void main(String[] args) throws SQLException {
		...
		for (int i = 0; i < items.length; i++) {
			...
			Item insertItem = new Item(i * (System.currentTimeMillis() / 3),
					"TestItem" + Integer.toString(i), 2.25 * i,
					System.currentTimeMillis(), testbool);
			items[i] = insertItem;
		}
